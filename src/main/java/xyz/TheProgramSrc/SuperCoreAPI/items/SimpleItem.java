...
import xyz.TheProgramSrc.SuperCoreAPI.translation.TranslationPack;
...
public class SimpleItem {
    ...
    public SimpleItem(TranslationPack pack){
        this(pack.translate());
    }
    ...
    public SimpleItem setLore(TranslationPack pack){
        this.addLoreLines("&7", pack.translate());
        return this;
    }
    ...
    public SimpleItem setDisplayName(TranslationPack pack){
        this.displayName = pack.translate();
        return this;
    }
