...
public class TranslationManager {
    ...
    public void registerTranslation(Class<? extends TranslationPack> clazz){
        try{
            ...
            file.createNewFile();
            String[] comments = {"# Default translation " + pack.getLanguage().toString(),"# If you want to edit the translations copy this file and rename it", "# The file name format is 'language_COUNTRY.lang'","# Also you can shearch about Java Locales"};
